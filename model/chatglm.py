...
class chatGLM2_6B:
    def __init__(self):
        self.tokenizer = AutoTokenizer.from_pretrained("/app/chatglm2-6b-32K", local_files_only=True)
        self.model = AutoModel.from_pretrained("/app/chatglm2-6b-32K", local_files_only=True).half().cuda()
