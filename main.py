...
async def create_chat_completion(request: ChatCompletionRequest):
    ...
    choice_data = ChatCompletionResponseChoice(index=0, message=message, finish_reason=finish_reason, history=history)
...
if __name__ == "__main__":
    tokenizer = AutoTokenizer.from_pretrained("/mnt/chatglm3-6b", trust_remote_code=True)
    model = AutoModel.from_pretrained("/mnt/chatglm3-6b", trust_remote_code=True).cuda()
